...
const MessageGroup = memo(function MessageGroup({ m, sessionId, date, showByline, live, layout, onMenu, nested, showProvisional }: {
  m: ChatMessage; sessionId: string; date?: string; showByline: boolean; live: boolean;
  layout: ReturnType<typeof createMessageLayout>; onMenu: MessageMenu; nested?: boolean; showProvisional?: boolean;
}) {
