...
export function Composer({ disabled, busy, placeholder, hint, submitLabel, draft, onSend, sendBlocked, onFocusPin }: ComposerProps) {
  ...
  return <>
    ...
    <div className="chat-input">
      <textarea ref={textarea} className="chat-input-message" aria-label="消息输入" aria-describedby={hint ? hintId : undefined} value={text}
