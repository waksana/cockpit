...
const toolMessage: ChatMessage = {
  ...
  toolCalls: [
    ...
    { toolCallId: 'design-mcp', name: 'chrome-devtools-evaluate_script', title: '检查工具行的布局',
      mcpServerName: 'chrome-devtools', mcpToolName: 'evaluate_script',
      status: 'completed', output: 'Synthetic browser output.' },
    { toolCallId: 'design-pending', name: 'cockpit-task-task_read', title: 'task_read',
      mcpServerName: 'cockpit-task', mcpToolName: 'task_read', status: 'pending' },
    { toolCallId: 'design-github', name: 'get_file_contents', title: 'Get file contents',
      mcpServerName: 'github-mcp-server', mcpToolName: 'get_file_contents', status: 'failed',
      output: 'Synthetic MCP failure. No network request was made.' },
    { toolCallId: 'design-legacy-mcp', name: 'legacy-server-read_record', title: '没有服务器名的旧记录', status: 'completed' },
