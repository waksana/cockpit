...
test('every session action has a mapped glyph and keeps its identity across live labels and disabled states', () => {
  ...
  assert.notEqual(initial[7].disabled, updated[7].disabled);
});
