...
| [Public types](../packages/module-api/src/backend.ts) | Package source: backend API; [frontend.ts](../packages/module-api/src/frontend.ts) for the Web API; [SDK entry points](module-sdk.md#install-from-github-packages). |
