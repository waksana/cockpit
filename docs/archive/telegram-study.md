...
> **历史归档，不是当前规范或操作指南。** [当前文档](../README.md) · [归档边界](README.md) · [原位置固定版本](https://github.com/waksana/cockpit/blob/a1f4a9a7c9e72b151958c270c4f790b32b72636e/docs/telegram-study.md)。
...
> 2026-09-08 范围校正：下文是未固定版本的历史研究，不代表当前登录后实测或实现规范。
> 本次公开源码参考为 Web K `a037b577c6f877e5d817402199a2facc84a53af3`、
> Web A `9cb10b20797dc09e33fcffee0ba390bb429c66d3`，不保证等于网站部署版本。
> K 的 row/topbar 菜单不同，删除走 `PopupDeleteDialog`，通用菜单采用普通 Tab/button 模型。
> Cockpit 以自身用户约定为准：共享单层 session 菜单、内容面板无跨页导航，
> 保留已有键盘/确认能力；不照搬媒体 tabs、嵌套菜单或转场状态。
