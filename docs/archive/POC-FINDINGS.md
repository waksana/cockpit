...
> **历史归档，不是当前规范或操作指南。** [当前文档](../README.md) · [归档边界](README.md) · [原位置固定版本](https://github.com/waksana/cockpit/blob/a1f4a9a7c9e72b151958c270c4f790b32b72636e/POC-FINDINGS.md)。
...
> 不应按此重新配置或开发。当前定位见
> [Cockpit 定位与验收准则](../product-requirements.md)，实现见
> [底座设计](../cockpit-plan.md)。
